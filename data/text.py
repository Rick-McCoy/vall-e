...
# ASCII
char_to_code.update({chr(i): i + 3 for i in range(128)})
# Hangul Jamo (Initial)
char_to_code.update({chr(i): i + 131 for i in range(0x1100, 0x1113)})
# Hangul Jamo (Medial)
char_to_code.update({chr(i): i + 144 for i in range(0x1161, 0x1176)})
# Hangul Jamo (Final)
char_to_code.update({chr(i): i + 157 for i in range(0x11A8, 0x11C3)})
